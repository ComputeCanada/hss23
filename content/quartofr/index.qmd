...
1. Ils sont d'abord transformés en Markdown étendu par Jupyter,
   lorsqu'utilisé avec Julia ou Python, ou par knitr, lorsqu'utilisé avec R.
1. Enfin, Pandoc compile les fichiers Markdown dans le format de votre choix.

{{<ex>}}
Julia et Python utilisent le moteur Jupyter :
{{</ex>}}
{{<img src="/img/quarto/qmd_jupyter.png" title="" width="90%" line-height="1.0rem">}}
Image tirée de la [documentation sur Quarto](https://quarto.org/docs/get-started/hello/text-editor.html#rendering){target="_blank"}
{{</img>}}
...
Image tirée de la [documentation sur Quarto](https://quarto.org/docs/faq/rmarkdown.html#quarto-sounds-similar-to-r-markdown.-what-is-the-difference-and-why-create-a-new-project){target="_blank"}
{{</img>}}
...
Image tirée de la [documentation sur Quarto](https://github.com/quarto-dev/quarto-web/blob/main/docs/get-started/hello/images/ipynb-how-it-works.png){target="_blank"}
{{</img>}}
...
1. Téléchargez Quarto
   [ici](https://quarto.org/docs/get-started/){target="_blank"} et installez-le.
...
- Téléchargez le compilateur Julia
  [ici](https://julialang.org/downloads/){target="_blank"} et installez-le.
- À partir de la ligne de commande Julia, installez les modules
  [IJulia](https://github.com/JuliaLang/IJulia.jl){target="_blank"} et
  [Revise](https://github.com/timholy/Revise.jl){target="_blank"} :
...
Pour référence :
[Quarto - Using Julia](https://quarto.org/docs/computations/julia.html#installation){target="_blank"}
...
- Téléchargez le compilateur Python 3
  [ici](https://www.python.org/downloads/){target="_blank"} et installez-le.
...
Pour référence :
[Quarto - Using Python](https://quarto.org/docs/computations/python.html#installation){target="_blank"}
...
- Téléchargez le compilateur R
  [ici](https://cran.r-project.org/){target="_blank"} et installez-le.
...
Pour référence :
[Quarto - Using R](https://quarto.org/docs/computations/r.html#installation){target="_blank"}
