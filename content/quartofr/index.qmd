...
Écrit en [YAML](https://fr.wikipedia.org/wiki/YAML){target="_blank"}
...
Voir [le guide de Quarto](https://quarto.org/docs/guide/){target="_blank"}
pour une liste exhaustive des options pour tous les formats.

#### Sections de texte

Les sections de texte sont écrites en
[Markdown étendu Pandoc](https://quarto.org/docs/authoring/markdown-basics.html){target="_blank"}.
...
* [**Afficher le résultat précompilé**](/quartofr/revealjs.html){target="_blank"}
...
* [**Afficher le résultat précompilé**](/quartofr/exemple_pdf.pdf){target="_blank"}
...
* [**Afficher le résultat précompilé**](/quartofr/exemple_r.html){target="_blank"}
...
* [**Afficher le résultat précompilé**](/quartofr/beamer.pdf){target="_blank"}
