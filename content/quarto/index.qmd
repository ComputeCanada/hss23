...
Register [here](https://www.eventbrite.ca/e/510984316847){target="_blank"}.
...
[Literate programming](https://en.wikipedia.org/wiki/Literate_programming){target="_blank"} is a methodology that combines snippets of code and written text. While first introduced in 1984, this approach to the creation of documents has truly exploded in popularity in recent years thanks to the development of new tools such as [R Markdown](https://r4ds.had.co.nz/r-markdown.html){target="_blank"} and, later, [Jupyter notebooks](https://jupyter.org/){target="_blank"}.
